homeTabPanel <- tabPanel(
  ...
  fluidRow(
    ...
    column(12, p("Para la propagación de trayectorias de satélites, la
                 ...
                 función de la época y las condiciones orbitales del
                  satélite.")),
  ...
  fluidRow(
    ...
    column(12, p("Para la visualización de trayectorias de satélites en el
                 ...
                 de la trayectoria en el mapa, incluyendo su posición,
                 velocidad y elementos keplerianos orbitales. Para la simulación
                  de trayectorias de satélites en el espacio, se utiliza
                  también la librería asteRisk, que permite la simulación de
                   trayectorias de satélites en el espacio.")),
  ),
  fluidRow(
  ...
  fluidRow(
    ...
    column(12, p("Este proceso es ", strong("importante"), " para el correcto
                 ...
                 tormentas solares y los datos de las tormentas
                 geomagnéticas.")),
  ),
  fluidRow(
    column(2, actionButton("get_latest_space_data",
